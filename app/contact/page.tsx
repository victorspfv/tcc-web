      ...
      <section className="bg-background py-16 md:py-20 lg:py-32 relative overflow-hidden">
        ...
        >
          <div className="flex flex-col items-center justify-center gap-16">
            {/* Icon */}
            <motion.div 
              className="w-24 h-24 bg-ppink rounded-full flex items-center justify-center border-1 border-black shadow-card"
            ...
            >
              <motion.p 
                className="text-3xl md:text-4xl font-pacifico text-ppink"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                ...
                >
                  <div className="flex flex-col items-center gap-6">
                    <motion.div 
                      className="w-16 h-16 bg-pblue rounded-full flex items-center justify-center border-1 border-black shadow-sm"
                      whileHover={{ rotate: -10, scale: 1.05 }}
                    >
                      <Instagram className="w-8 h-8 text-white" />
                    </motion.div>
                    <h3 className="text-xl font-bold">Instagram</h3>
                    <a href="https://www.instagram.com/jointheclosetclique/">@Jointheclosetclique</a>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex flex-col items-center gap-6">
                    <motion.div 
                      className="w-16 h-16 bg-pyellow rounded-full flex items-center justify-center border-1 border-black shadow-sm"
                      whileHover={{ rotate: 10, scale: 1.05 }}
                    >
              ...
              <motion.div 
                ...
                variants={itemVariants}
              >
                <h2 className="text-3xl font-pacifico text-foreground mb-8 text-center">Send us a message</h2>
                <p className="text-lg leading-relaxed text-foreground text-center mb-12">
                  We&apos;d love to hear from you! Whether you have a question,
                  want to join the waitlist, or are interested in becoming an ambassador,
