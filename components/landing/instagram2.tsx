...
export default function Instagram2() {
    ...
    return (
        <section className="bg-gray-100 overflow-hidden w-full">
            <motion.div
                className="relative"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full">
                    <motion.div
                        className="col-span-1 flex flex-col w-max-w-lg h-full items-start p-4 md:p-10 gap-6 justify-center"
                        ...
                        <motion.p
                            className="text-lg text-muted-foreground md:text-2xl max-w-xl"
                            variants={contentVariants}>
                    ...
                    <motion.div className="h-full col-span-1 flex items-start overflow-hidden" variants={gridVariants}>
                        <motion.div className="grid grid-cols-4 gap-0 w-full" variants={gridVariants}>
