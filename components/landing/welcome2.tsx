...
export default function Welcome2() {
    return (
        <section className="bg-white py-10 px-4">
            <div className="container flex flex-col items-center justify-center pb-32 lg:pt-20">
                <header>
                    <h2 className="mt-6 text-center text-4xl tracking-tighter lg:text-7xl font-pacifico">
                ...
                <div className="group">
                    <div className="relative flex items-center justify-center">
                        ...
                        <div className="absolute -right-25 -bottom-20 flex items-end md:-right-52">
                            ...
                            <p className="font-pacifico text-xl tracking-tight text-foreground">
